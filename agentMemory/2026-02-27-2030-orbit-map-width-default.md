...
## Files Touched
- [uncommitted] `src/app/_components/atlas-map-shell.tsx` - widened sticky map wrapper, reduced map-lane gutters, and finalized left-aligned body spacing to keep parent/child clusters close.
